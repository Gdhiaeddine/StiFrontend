      ...
      <div className="relative mx-auto w-full max-w-[1320px] px-6 lg:px-8">
        ...
        >
          <ol className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-gray-400">
            ...
            <li className="text-gray-700">{t.contact?.hero?.badge || "Contact Us"}</li>
          </ol>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <span className="mb-4 inline-block text-xs font-bold uppercase tracking-widest text-red-primary">
              {t.contact?.hero?.badge || "Contact STI"}
            </span>
            ...
            >
              {t.contact?.hero?.title || "Get in Touch with Our Team"}
            </h1>

            <p className="max-w-xl text-lg leading-relaxed text-gray-500 mb-8">
              {t.contact?.hero?.subtitle || "Have questions about our Ooredoo products or distribution services? Contact SARL STI today for dedicated partner support."}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              >
                {t.contact?.hero?.cta_form || "Send a Message"}
              ...
              >
                <Phone size={16} />
                {t.contact?.hero?.cta_call || "Call Support"}
              </a>
            </div>
          </motion.div>
