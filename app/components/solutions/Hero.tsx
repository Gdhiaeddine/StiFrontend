      ...
      <div className="relative mx-auto w-full max-w-[1320px] px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              Distribution <span className="text-red-primary">Solutions</span>
            </motion.h1>
            ...
            >
              STI provides reliable Ooredoo mobile recharge credit and prepaid SIM card distribution across Algeria, helping retailers, wholesalers, and business partners maintain continuous product availability.
            </motion.p>
          </div>
