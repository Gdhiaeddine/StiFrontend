...
export default function Hero() {
  ...
  const heroT = t.solutionsPage?.hero || {
    breadcrumb_home: "Home",
    breadcrumb_current: "Solutions",
    badge: "Our Solutions",
    title_line1: "Distribution",
    title_line2: "Solutions",
    description: "STI provides reliable Ooredoo mobile recharge credit and prepaid SIM card distribution across Algeria, helping retailers, wholesalers, and business partners maintain continuous product availability.",
  };
    ...
    <section className="relative flex items-center bg-white pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-[1320px] px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative w-full max-w-[750px] aspect-square mx-auto lg:mx-0 lg:-ml-12">
              <Image
                src="/assets/solutions.png"
                alt="STI Distribution Solutions"
                fill
