...
export default function NewsHero() {
  ...
  const heroT = t.newsPage?.hero || {
    breadcrumb_home: "Home",
    breadcrumb_current: "News",
    badge: "Latest Updates",
    title_line1: "News &",
    title_line2: "Updates",
    description: "Stay informed with the latest announcements from SARL Smart Technologie Innovation (STI), including official Ooredoo product updates, partnership news, promotions, company milestones, and telecom distribution insights across Algeria.",
    cta_primary: "Latest News",
    ...
    <section className="relative flex items-center bg-white pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-[1320px] px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative w-full max-w-[780px] aspect-square mx-auto lg:mx-0 lg:-ml-12 lg:scale-110">
              <Image
                src="/assets/news.png"
                alt="STI News & Updates"
                fill
